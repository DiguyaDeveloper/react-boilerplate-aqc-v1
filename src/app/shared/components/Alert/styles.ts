...
export const AlertBox = styled.div<IAlertBoxProps>`
	visibility: ${(props: { visibility: any; }) => (props.visibility ? 'visible' : 'hidden')};
	position: fixed;
	min-width: 400px;
	max-width: 80%;
	margin-left: -250px;
	...
	z-index: 1;
	right: 20px;
	bottom: ${(props: { visibility: any; }) => (props.visibility === 'visible' ? '30px' : '-100px')};
...
export const AlertTitle = styled.span<IAlertTitleProps>`
	font-family: ${(props: { theme: { fonts: { title: any; }; }; }) => props.theme.fonts.title};
	font-size: 1.5em;
	margin: 0.3em;
	color: ${(props: { type: any; }) => alertTitleColor(props.type)};
`;
...
export const AlertMessage = styled.span`
	font-family: ${(props: { theme: { fonts: { body: any; }; }; }) => props.theme.fonts.body};
	font-size: 1.2em;
	margin: 0.3em;
`;
